...
export const about = {
  paragraphs: [
    ...
    "Away from the screen, I train martial arts — currently Iaido, after years of taekwondo, karate, Muay Thai, and MMA — play piano, draw, and read whenever I get the chance.",
  ],
  interests: ["Martial Arts (Iaido)", "Piano", "Drawing", "Reading"],
};
